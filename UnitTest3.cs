...
namespace SeleniumTests
{
    ...
    public class 13
    {
        ...
        public void The13Test()
        {
            ...
            driver.FindElement(By.Id("input-email")).SendKeys("mihael.istvan@gmail.com");
            driver.FindElement(By.Id("input-password")).Click();
            driver.FindElement(By.Id("input-password")).Clear();
            driver.FindElement(By.Id("input-password")).SendKeys("password");
            driver.FindElement(By.Id("input-password")).SendKeys(Keys.Enter);
            driver.FindElement(By.LinkText("Edit your account information")).Click();
            driver.FindElement(By.XPath("//div[@id='content']/form/fieldset/div")).Click();
            driver.FindElement(By.Id("input-firstname")).Clear();
            driver.FindElement(By.Id("input-firstname")).SendKeys("first name");
            driver.FindElement(By.XPath("//div[@id='content']/form/fieldset/div[2]")).Click();
            driver.FindElement(By.Id("input-lastname")).Clear();
            driver.FindElement(By.Id("input-lastname")).SendKeys("last name");
            driver.FindElement(By.XPath("//div[@id='content']/form/fieldset")).Click();
